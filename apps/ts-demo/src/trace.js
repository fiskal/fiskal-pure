...
export function printTraceReport() {
    ...
    if (subscriptionTimings.length > 0) {
        ...
        console.table(Object.fromEntries([...byName.entries()].map(([k, v]) => [
            k,
